...
<div id="main-content">
    <div class="page-content">
        <section class="modals">
            <div class="modal fade" id="eventGroupAddEditModal" tabindex="-1" role="dialog"
                aria-labelledby="eventGroupAddEditModalTitle" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-centered modal-dialog-scrollable"
                    role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="eventGroupAddEditModalTitle">Add Group</h5>
            ...
            <div class="col-12 col-lg-12">
                <div class="card">
                    <div class="card-header py-3">
                        <h3 class="card-title m-0">Event Group(s)</h3>
                    </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group d-flex flex-column flex-md-row justify-content-start align-items-start align-items-md-center gap-1">
                                        <button class="btn btn-primary" data-bs-toggle="modal"
                                            data-bs-target="#eventGroupAddEditModal"><i class="fa fa-plus me-1"></i>New</button>
                                        ...
                                        <input type="text" class="form-control form-control-sm shadow-none" placeholder="Search Event Groups"
                                            id="searchEventGroup" style="max-width: 250px;">
                                    </div>
                                </div>
                                <hr class="my-2" />
                                <div class="col-12">
                                    <div class="table-responsive">
                                        <table class="table mb-0 table-striped" id="eventGroupTable">
                                            <thead>
                                                <tr>
                                                    <th>S.No</th>
                                                    <th>Name</th>
...
<script type="text/javascript">
    $(document).on('click', '.export', function() {
        ...
        let styleTitle = `Event Group List`;
        let styleDescription = `List of all event groups in the system.`;
        switch (option) {
            case 'xls':
                fnExcelParmReport("#eventGroupTable", styleTitle, styleDescription, `eventgroups`);
                break;
            case 'xlsx':
                fnExcelParmReportXlsx("#eventGroupTable", styleTitle, styleDescription, `eventgroups`);
                break;
            case 'csv':
                fnCsvParmReport("#eventGroupTable", styleTitle, styleDescription, `eventgroups`);
                break;
        }
    });
    $("#searchEventGroup").on("keyup", function() {
        var value = $(this).val().toLowerCase();
        $("#eventGroupTable tbody tr").filter(function() {
